...
| [Products feature handover](./PRODUCTS_HANDOVER.md) | Product / frontend / backend | Product/script model, campaign product selection, reports product filter, end-to-end test checklist |

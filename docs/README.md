...
| [Frontend architecture](./frontend-architecture.md) | Frontend / QA / integration | App shell routing, standalone `/tv` and `/flow-builder` routes, state/data flow, UI constraints |

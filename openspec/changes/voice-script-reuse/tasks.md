...
- [ ] 4.1 Lint/typecheck `VoiceGenerator.tsx`, `voice-scripts/route.ts`, `tts/save/route.ts`
- [ ] 4.2 Manual: save two scripts → bubbles appear → ▶ plays → click loads text + restores voice
- [ ] 4.3 `openspec validate voice-script-reuse --strict`
